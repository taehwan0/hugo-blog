...
## Contents
- [Velog는 뭔가 부끄러웠다.](#velog는-뭔가-부끄러웠다)
- [Hugo 블로그 작성하기](#hugo-블로그-작성하기)
  - [0. Hugo 설치하기](#0-hugo-설치하기)
  - [1. 사이트 생성하고, 테마 설치하기](#1-사이트-생성하고-테마-설치하기)
  - [2. 첫 글 작성하기](#2-첫-글-작성하기)
  - [3. 블로그 배포하기](#3-블로그-배포하기)
- [마무리](#마무리)

## Velog는 뭔가 부끄러웠다.

취업 이전에 깔짝. 그리고 취업 이후에도 동기들과 블로그 쓰기 내기를 하면서 또 깔짝.
Velog에 글을 작성하던 두 번의 깔짝임이 있었다.
언젠가부터는 글을 쓰지 않게 됐었다.
개발 공부를 지속적으로 하고 있었지만, 블로그 보다는 개인적으로 공부한 내용을 정리하는 것을 선호하게 됐다.
그 이유는 Velog가 너무 보여지는 느낌이었기 때문인 것 같다.
그래서 언제부터인가 자연스럽게 블로그를 쓰지 않게 됐다. (그렇다고 글을 많이 쓴 것도 아니고 자주  쓴 것도 아니고..)

그러다가 요즘 들어서 다시 블로그를 쓰고 싶다는 생각이 들었는데 직접 호스팅을 해보고 싶다는 생각이 들어 Hugo를 사용해서 블로그를 만들어보기로 했다.
Hugo, Jelly, Gatsby 등 다양한 정적 사이트 생성기들이 있지만, 이 시점에서는 Hugo가 가장 눈에 들어왔다.
md 기반은 언제든 옮기기 쉽지 않을까 싶어 도구를 딥하게 알아보는 것 보다는 일단 시작해봤다.

무튼 보다 더 아지트 같은 느낌으로 자유롭게 뻘글도 쓰고, 공부도 하고, 장난감도 올려보려고 한다.
첫 장난감은 이 블로그가 되겠다.
...
![hugo help 명령어](/static/images/hugo-help-command.png)
...
![blog-첫-실행](/static/images/ananke-theme-blog.png)
...
![첫글-작성하기](/static/images/hugo-first-post.png)
...
![WebStorm 마크다운 에디터](/static/images/webstorm-markdown-editor.png)
...
> 직접 호스팅을 해보고 싶다는 생각이 들어 Hugo를 사용해서 블로그를 만들어보기로 했다.
...
![github-action-시행착오](/static/images/hugo-github-actions-try.png)
